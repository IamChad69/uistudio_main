...
export default function HeroVideoDialog({
  ...
  return (
    <div className={cn("relative w-full", className)}>
      ...
      >
        <div className="relative -m-2 rounded-xl bg-gray-900/5 p-2 ring-1 ring-inset ring-gray-900/10 lg:-m-4 lg:rounded-2xl lg:p-4 w-full">
          <Image
            src={thumbnailSrc}
            alt={thumbnailAlt}
            width={2432}
            height={1442}
            className="w-full rounded-md shadow ring-1 ring-gray-900/10 transition-all duration-200 ease-out group-hover:brightness-[0.9]"
          />
        </div>
